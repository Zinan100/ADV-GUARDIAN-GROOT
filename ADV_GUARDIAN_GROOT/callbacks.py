...
𝙃𝙤𝙬 𝙬𝙞𝙡𝙡 𝙄 𝙪𝙨𝙚 𝙞𝙩 ?
   ᴛᴏ ᴜꜱᴇ ᴛʜᴇ ꜰᴇᴜᴛᴜʀᴇ yᴏᴜ ʜᴀᴠᴇ ᴛᴏ ᴄʟɪᴄᴋ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟʟᴏᴡ ɴᴀᴍᴇᴅ ᴛᴇꜱᴛ ᴍy ʙʀᴀɪɴ ᴀɴᴅ ᴀ ᴄᴏᴅᴇ ᴡɪʟʟ ᴩᴏᴩᴜᴩ ᴀɴᴅ ᴠᴀɴ8ꜱʜ ɪɴ 2 ꜱᴇᴄᴏɴᴅꜱ and answer the code example:/ans <put the code herecode>.""",
            reply_markup=InlineKeyboardMarkup( [[
